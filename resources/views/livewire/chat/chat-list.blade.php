...
class="flex flex-col transition-all h-full overflow-hidden">
    <header class="px-3 z-10 bg-white sticky top-0 w-full py-2">
        ...
        <div class="flex gap-3 items-center overflow-x-scroll p-2 bg-white">
            <button @click="type='all'" :class="{'bg-blue-100 border-0 text-black' :type=='all'}" class="inline-flex justify-center items-center rounded-full gap-x-1 text-xs font-medium px-3 lg:py-2.5 border-b ">
                all
            </button>
            <button @click="type='deleted'" :class="{'bg-blue-100 border-0 text-black' :type=='deleted'}" class="inline-flex justify-center items-center rounded-full gap-x-1 text-xs font-medium px-3 lg:py-2.5 border-b ">
                delete
            </button>
        </div>
    </header>
        ...
        <ul class="p-2 grid w-full space-y-2">
            @if ($conversations)
                ...
                <li
                 ...
                 class="py-3 hover:bg-gray-50 rounded-2xl transition-colors duration-150 flex gap-4 relative w-full cursor-pointer px-2 {{$conversation->id == $selectedConversation?->id ? 'bg-gray-100/70' : ''}}">
                    ...
                    <aside class=" grid grid-cols-12 w-full">
                        ...
                        <div class="col-span-1 flex flex-col text-center my-auto">
                            ...
                            <x-dropdown align="right" width="48">
                                ...
                                <x-slot name="content" class=" bg-gray-300">
                                    <div class="w-full p-1 bg-gray-300">
                                        <button class="items-center gap-3 flex w-full px-4 py-2 text-left text-sm leading-5 text-gray-500 hover:bg-gray-100 transition-all duration-150 ease-in-out focus:bg-gray-100">
                                            <span>
